...
import os
os.chdir("Y:/dissModels/fastTgcnVersions/fastTgcnEasy/")
from Baseline import Baseline
from dataloader import plydataset
from utils import test_semseg

device = "cpu"
pthPath = "Y:/dissModels/fastTgcnVersions/fastTgcnEasy/modelOutputs/2026_01_27 full upper/checkpointsAndLogs/checkpoints"



# --- CPU shim so utils.test_semseg() works on machines without GPUs ---
if not torch.cuda.is_available():
    def _noop_cuda(self, *args, **kwargs):
        return self
    torch.Tensor.cuda = _noop_cuda
    def _noop_module_cuda(self, *args, **kwargs):
        return self.cpu()
...
arch = "u" 
data_dir = "H:/schoolFiles/dissertation/rmeData/convertedTest"
...
data_dir = "H:/schoolFiles/dissertation/rmeData/"
from pathlib import Path
outDir = "convertedTestPreds"  
