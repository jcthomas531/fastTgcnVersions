...
dtpe.dfToPlyExport(vertDf =  m1Vert, faceDf = m1Face, outFile = m1OutPath)
#for orientation, can also turn on grid to show size and alignment
#import readAndPlot as rap
#rap.readAndPlot(file = "K:/masterArches/masterArch1/mA1Full.ply", arch = "U")
